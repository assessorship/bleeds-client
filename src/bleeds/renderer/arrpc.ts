...
import { Logger } from "@Bleeds Client/types/utils";
import { findLazy, onceReady } from "@Bleeds Client/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@Bleeds Client/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("BleedsRPC", "#5865f2");
