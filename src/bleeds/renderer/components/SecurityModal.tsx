...
import { Button, Flex, Heading, Paragraph } from "@Bleeds Client/types/components";
import { ModalContent, ModalFooter, ModalHeader, ModalRoot, ModalSize } from "@Bleeds Client/types/utils";
            ...
            <ModalContent style={{ padding: "16px 24px" }}>
                <div style={{
                    ...
                    <Paragraph style={{ fontWeight: "bold", marginBottom: "6px", color: "var(--text-normal)" }}>
                        BleedsFr is a 100% Free product.
                    </Paragraph>
                ...
                <div style={{
                    ...
                    <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                        <li style={{ marginBottom: "6px", color: "var(--text-normal)" }}>
                            <strong>owner:</strong> FundedSerials
                        </li>
                        <li style={{ color: "var(--text-normal)" }}>
                            <strong>Support &amp; Community:</strong>{" "}
                            <span
                                style={{ color: "var(--text-link)", cursor: "pointer" }}
                                onClick={() => window.open("https://discord.gg/bleedsclient", "_blank")}
                            >
                                discord.gg/bleedsclient
                            </span>
                        </li>
                    </ul>
                </div>
                ...
                <div style={{
                    ...
                    <Paragraph style={{ color: "var(--text-muted)", fontStyle: "italic", fontSize: "13px" }}>
                        <strong>Note:</strong> Only download BleedsFr via our official channels to ensure your security.
                    </Paragraph>
                </div>
            </ModalContent>
