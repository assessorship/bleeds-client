...
import { Heading, Paragraph } from "@Bleeds Client/types/components";
import { Margins } from "@Bleeds Client/types/utils";
import { Select } from "@Bleeds Client/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind Bleeds Client for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
