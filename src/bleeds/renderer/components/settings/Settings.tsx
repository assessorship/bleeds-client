...
import { classNameFactory } from "@Bleeds Client/types/api/Styles";
import { BaseText, Divider, ErrorBoundary } from "@Bleeds Client/types/components";
...
const SettingsOptions: Record<string, Array<BooleanSetting | SettingsComponent>> = {
    ...
    "User Interface": [
        ...
        },
        {
            key: "staticTitle",
            title: "Static Title",
            description: 'Makes the window title "Bleeds Client" instead of changing to the current page',
            defaultValue: false
        },
        {
            key: "enableMenu",
        ...
        },
        {
            ...
            description:
                "Shows a small splash screen while Bleeds Client is loading. Disabling this option will show the main window earlier while it's still loading.",
            defaultValue: true
        },
        {
            key: "splashTheming",
    ...
    Behaviour: [
        {
            key: "tray",
            title: "Tray Icon",
            description: "Add a tray icon for Bleeds Client",
            defaultValue: true,
            invisible: () => isMac
        },
        {
            ...
            description: "Hitting X will make Bleeds Client minimize to the tray instead of closing",
            defaultValue: true,
            invisible: () => isMac,
        ...
        },
        {
            ...
            description: "Left clicking tray icon will toggle the Bleeds Client window visibility.",
            defaultValue: false
        },
        {
            key: "disableMinSize",
    ...
    Miscellaneous: [
        ...
        },
        {
            ...
            description: "Opens links in a new Bleeds Client window instead of your web browser",
            defaultValue: false
        }
    ],
...
export default ErrorBoundary.wrap(
    ...
    {
        message:
            "Failed to render the Bleeds Client Settings tab. If this issue persists, try to right click the Bleeds Client tray icon, then click 'Repair Bleeds Client'. And make sure your Bleeds Client is up to date."
    }
);
