...
import { Button, Card, HeadingTertiary, Paragraph } from "@Bleeds Client/types/components";
import { useAwaiter } from "@Bleeds Client/types/utils";
...
export function OutdatedVesktopWarning() {
    ...
    return (
        <Card variant="warning" className={cl("updater-card")}>
            <HeadingTertiary>Your Bleeds Client is outdated!</HeadingTertiary>
