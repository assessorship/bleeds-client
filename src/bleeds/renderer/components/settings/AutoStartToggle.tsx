...
import { useState } from "@Bleeds Client/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start Bleeds Client on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start Bleeds Client minimized when starting with system"}
