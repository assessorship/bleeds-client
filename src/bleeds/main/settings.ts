...
export const Settings = loadSettings<TSettings>(SETTINGS_FILE, "Bleeds Client settings");
export const VencordSettings = loadSettings<any>(VENCORD_SETTINGS_FILE, "Vencord settings");
export const State = loadSettings<TState>(STATE_FILE, "Bleeds Client state");
