...
function initMenuBar(win: BrowserWindow) {
    ...
    const subMenu = [
        ...
        {
            label: "Force Update Bleeds Client",
            async click() {
            ...
            toolTip: "Bleeds Client will automatically restart after this operation"
        },
        {
