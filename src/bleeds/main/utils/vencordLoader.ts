...
export async function downloadVencordAsar() {
    await downloadFile(
        "https://github.com/Bleeds Client/Bleeds Client/releases/latest/download/bleeds.asar",
        VENCORD_DIR,
        {},
...
export function isValidVencordInstall(dir: string) {
    return existsSync(join(dir, "Bleeds Client/main.js"));
}

export async function ensureVencordFiles() {
    if (!existsSync(VENCORD_DIR)) {
        console.error("Bundled bleeds.asar not found at", VENCORD_DIR);
    }
}
