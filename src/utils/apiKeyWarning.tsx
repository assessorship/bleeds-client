/*
 * Bleeds Client — Utilitaire pop-up clé API manquante
 */
            ...
            <ModalContent style={{ padding: "24px 20px 8px" }}>
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12, textAlign: "center" }}>
                    ...
                    <div style={{ fontSize: 14, color: "#fff", lineHeight: 1.5 }}>
                        ...
                        <br /><br />
                        Configure-la une seule fois dans les paramètres de <strong style={{ color: "#fff" }}>bleedsAI</strong>.
                    </div>
                </div>
            </ModalContent>
