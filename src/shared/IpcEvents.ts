...
export const enum IpcEvents {
    ...
    SET_WINDOW_BACKGROUND_MATERIAL = "BleedsSetWindowBackgroundMaterial",
    ...
    // Bleeds Client Updater — télécharge un exe depuis une URL et le lance
    BLEEDS_DOWNLOAD_AND_RUN = "BleedsDownloadAndRun",

    // VB-Audio Virtual Cable (Windows only)
    CHECK_VB_CABLE = "BleedsCheckVBCable",
    INSTALL_VB_CABLE = "BleedsInstallVBCable",



    // Relaunch de l'app Electron
    RELAUNCH_APP = "BleedsRelaunchApp",
