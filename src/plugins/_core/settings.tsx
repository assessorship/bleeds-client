...
import IconsTab from "@bleedsplugins/iconViewer/components/IconsTab";
...
import { CreateThemeTab } from "@bleedsplugins/createTheme/components/CreateThemeTab";
import { PencilSparkleIcon } from "@bleedsplugins/createTheme/components/PencilSparkleIcon";
...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Bleeds Client settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const mainEntry = buildEntry({
            key: "equicord_main",
            title: "Bleeds Client",
            panelTitle: "Bleeds Client Settings",
        ...
        const fullEntries: SettingsLayoutNode[] = [
            ...
            !IS_UPDATER_DISABLED && UpdaterTab && buildEntry({
                ...
                title: "Updater",
                panelTitle: "Bleeds Client Updater",
        ...
        const equicordSection: SettingsLayoutNode = {
            ...
            useTitle: () => {
                try { if (localStorage.getItem("BLEEDS_stealthMode") === "1") return ""; } catch { }
                return "Bleeds Client Settings";
            },
            buildLayout: () => {
                try { if (localStorage.getItem("BLEEDS_stealthMode") === "1") return [mainEntry]; } catch { }
                return fullEntries;
            }
        };
    ...
    getInfoRows() {
        ...
        const rows = [`Bleeds Client ${gitHashShort}${getVersionInfo()}`];
