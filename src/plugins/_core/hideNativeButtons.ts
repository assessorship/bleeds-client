/*
 * Bleeds Client — Injection CSS globale pour masquer les boutons natifs Discord
 */

import { Devs } from "@utils/constants";
import definePlugin from "@utils/types";

const STYLE_ID = "Bleeds Client-hide-native-buttons";

const CSS = `
/* ── Bleeds Client : suppression boutons natifs Discord non désirés ── */
