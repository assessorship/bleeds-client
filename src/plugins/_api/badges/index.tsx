...
let BleedsBadges = {} as Record<string, Array<Record<"tooltip" | "badge", string>>>;
...
async function loadAllBadges(noCache = false) {
    ...
    const bleedsBadgesData = await loadBadges("https://gist.githubusercontent.com/Bleedsoff/29ff0da4ebd5a7e36acdf97be24f28c9/raw/badges.json", noCache).catch(() => ({}));

    DonorBadges = vencordBadges;
    EquicordDonorBadges = equicordBadges;
    BleedsBadges = bleedsBadgesData;
}
...
export default definePlugin({
    ...
    getBleedsBadges(userId: string) {
        try {
            const userBadges = BleedsBadges[userId];
            ...
            for (const badge of userBadges) {
                ...
                results.push({
                    iconSrc: iconSrc,
                    description: (badge as any).tooltip || (badge as any).description || (badge as any).label || "Bleeds Client Badge",
