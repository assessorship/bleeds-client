/*
 * Bleeds Client — Onglet Updater dans les Settings
...
const REPO_URL = "https://github.com/bleedsclient/bleeds-client";
...
function UpdaterTab() {
    ...
    return (
        <SettingsTab>
            <Heading className={Margins.top16}>Bleeds Client Updater</Heading>
            <Paragraph className={Margins.bottom20}>
                Check for new versions of Bleeds Client. Updates can be installed automatically.
            </Paragraph>
            ...
            <Card style={{ padding: "12px 16px", marginBottom: 12 }}>
                <Flex style={{ alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <div>
                        ...
                        <div>
                            <Link href="https://bleedsclient.xyz" style={{ fontSize: 13 }}>
                                bleedsclient.xyz
                            </Link>
                        </div>
                    </div>
