...
import { ContributeModal } from "../../../../bleeds/renderer/components/ContributeModal";
...
const DEV_TEAM = [
    {
        ...
        description: "Founder and owner of Bleeds Client."
    },
    {
        id: "kza",
        name: "Kza",
        ...
        description: "Co-owner of Bleeds Client."
    },
    {
        id: "attachante",
        name: "attachante",
        ...
        description: "Developer within the Bleeds Client team."
    },
    {
        id: "Fancy",
        name: "Fancy",
    ...
    },
    {
        ...
        description: "Bot developer for Bleeds Client."
    },
    {
        id: "biemal",
        name: "Biemal",
        ...
        description: "WebApp developer within the Bleeds Client team."
    }
];
    ...
    return (
        <>
            <QuickActionCard>
                ...
                <QuickAction
                    Icon={PlanetIcon}
                    text="Bleeds Client Server"
                    action={() => window.open("https://discord.gg/bleedsclient", "_blank")}
                />
            </QuickActionCard>
...
function useStealthActive() {
    ...
    React.useEffect(() => {
        ...
        window.addEventListener("Bleeds Client-stealth-change", handler);
        return () => window.removeEventListener("Bleeds Client-stealth-change", handler);
    }, []);
    return active;
}
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom16}>
                {enabled
                    ? "Stealth mode is enabled — all Bleeds Client visual elements are hidden. Shortcut: Ctrl+Shift+H"
                    : "Hides all Bleeds Client visual elements (icons, buttons, context menus) without disabling plugins. Shortcut: Ctrl+Shift+H"}
            </Paragraph>
            <Button
    ...
    return (
        <SettingsTab>
            ...
            {!stealthActive && (<>
                ...
                <Paragraph className={Margins.bottom16}>
                    Configure how Bleeds Client behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
                </Paragraph>
                ...
                <Paragraph className={Margins.bottom16}>
                    Configure how Bleeds Client handles notifications. You can customize when and how you receive alerts, or view a history of past notifications.
                </Paragraph>
            ...
            <Heading className={Margins.top20}>Stealth Mode</Heading>
            <Paragraph className={Margins.bottom16}>
                Hides all Bleeds Client visual elements without disabling plugins. Shortcut: Ctrl+Shift+H
            </Paragraph>
            <StealthModeButton />
...
export default wrapTab(EquicordSettings, "Bleeds Client Settings");
