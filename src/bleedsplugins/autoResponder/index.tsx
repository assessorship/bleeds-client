...
import { groqChat, getGroqKey } from "../bleedsAI/groqManager";
            ...
            <div style={{
                ...
                <div>
                    ...
                    <div style={{ fontSize: "13px", marginTop: "4px" }}>
                        ...
                        Please configure it once in the <strong>bleedsAI</strong> settings.
                    </div>
                </div>
            </div>
        )
        ...
        if (!apiKey) {
            try {
                ...
                openConfirmationModal({
                    ...
                    content: "AutoResponder requires a Groq API Key to function. Please configure it once in the bleedsAI settings.",
                    confirmText: "Configure bleedsAI",
                    cancelText: "Cancel",
                    onConfirm: () => {
                        const { openModal } = findByPropsLazy("openModal");
                        // Logique pour ouvrir les settings bleedsAI si possible
                    }
                });
            } catch (e) {
