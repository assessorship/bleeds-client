...
"use strict";function l(e,t=300){let r;return function(...s){clearTimeout(r),r=setTimeout(()=>{e(...s)},t)}}var i=require("electron/renderer");var n=require("electron/renderer");function o(e,...t){return n.ipcRenderer.invoke(e,...t)}function d(e,...t){return n.ipcRenderer.sendSync(e,...t)}var c={},R=d("VencordGetPluginIpcMethodMap");for(let[e,t]of Object.entries(R)){let r=c[e]={};for(let[s,_]of Object.entries(t))r[s]=(...E)=>o(_,...E)}var a={themes:{uploadTheme:async(e,t)=>{throw new Error("uploadTheme is WEB only")},deleteTheme:e=>o("VencordDeleteTheme",e),getThemesDir:()=>o("VencordGetThemesDir"),getThemesList:()=>o("VencordGetThemesList"),getThemeData:e=>o("VencordGetThemeData",e),getSystemValues:()=>o("VencordGetThemeSystemValues"),openFolder:()=>o("VencordOpenThemesFolder")},updater:{getUpdates:()=>o("VencordGetUpdates"),update:()=>o("VencordUpdate"),rebuild:()=>o("VencordBuild"),getRepo:()=>o("VencordGetRepo"),downloadAndRun:e=>o("BleedsDownloadAndRun",e)},settings:{get:()=>d("VencordGetSettings"),set:(e,t)=>o("VencordSetSettings",e,t),getSettingsDir:()=>o("VencordGetSettingsDir"),openFolder:()=>o("VencordOpenSettingsFolder")},quickCss:{get:()=>o("VencordGetQuickCss"),set:e=>o("VencordSetQuickCss",e),addChangeListener(e){n.ipcRenderer.on("VencordQuickCssUpdate",(t,r)=>e(r))},addThemeChangeListener(e){n.ipcRenderer.on("VencordThemeUpdate",()=>e())},openFile:()=>o("VencordOpenQuickCss"),openEditor:()=>o("VencordOpenMonacoEditor"),getEditorTheme:()=>d("VencordGetMonacoTheme")},native:{getVersions:()=>process.versions,openExternal:e=>o("VencordOpenExternal",e),getRendererCss:()=>o("VencordGetRendererCss"),onRendererCssUpdate:e=>{}},csp:{isDomainAllowed:(e,t)=>o("VencordCspIsDomainAllowed",e,t),removeOverride:e=>o("VencordCspRemoveOverride",e),requestAddOverride:(e,t,r)=>o("VencordCspRequestAddOverride",e,t,r)},tray:{setUpdateState:e=>n.ipcRenderer.send("VencordSetTrayUpdateState",e),onCheckUpdates:e=>{n.ipcRenderer.on("VencordTrayCheckUpdates",e)},onRepair:e=>{n.ipcRenderer.on("VencordTrayRepair",e)}},desktopCapture:{getSources:()=>o("VencordGetDesktopSources")},Bleeds:{checkVBCable:()=>o("BleedsCheckVBCable"),installVBCable:()=>o("BleedsInstallVBCable"),relaunch:()=>o("BleedsRelaunchApp")},pluginHelpers:c,window:{setBackgroundMaterial:e=>o("BleedsSetWindowBackgroundMaterial",e),setThumbarButtons:e=>o("SoundCordSetThumbarButtons",e),onThumbarClick:e=>{n.ipcRenderer.on("SoundCordThumbarButtonClick",(t,r)=>e(r))},removeThumbarClickListener:()=>{n.ipcRenderer.removeAllListeners("SoundCordThumbarButtonClick")}},worldBomb:{type:(e,t)=>o("WorldBombType",e,t),pressEnter:()=>o("WorldBombPressEnter"),pressBackspace:()=>o("WorldBombPressBackspace"),sequence:(e,t,r,s=-1,_=-1)=>o("WorldBombSequence",e,t,r,s,_),openWindow:(e,t,r,s,_,E,u)=>o("WorldBombOpenWindow",e,t,r,s,_,E,u),getCursorPos:()=>o("WorldBombGetCursorPos")},keyboardSounds:{startGlobalHook:()=>o("KeyboardSoundsStartGlobal"),stopGlobalHook:()=>o("KeyboardSoundsStopGlobal"),onGlobalKeyDown:e=>{n.ipcRenderer.on("GlobalKeyDown",(t,r)=>e(r))},removeGlobalKeyDownListener:()=>{n.ipcRenderer.removeAllListeners("GlobalKeyDown")}}};i.contextBridge.exposeInMainWorld("VencordNative",a);location.protocol!=="data:"?(o("VencordInitFileWatchers"),i.webFrame.executeJavaScript(`
        ...
        `),i.webFrame.executeJavaScript(d("VencordPreloadGetRendererJs")),require(process.env.DISCORD_PRELOAD),i.webFrame.executeJavaScript(`
            (function() {
                function patchTitle(t) {
                    return t ? t.replace(/Discord/g, 'Bleeds Client') : t;
                }
                // Patch initial
