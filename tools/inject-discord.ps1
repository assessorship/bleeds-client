# ==============================================================================
#  Bleeds Client — Script d'injection Post-Installation
#  Utilisé par l'installateur Inno Setup pour injecter Bleeds Client dans Discord.
# ==============================================================================
...
# On pointe vers le patcher.js dans le dossier d'installation de Bleeds Client
$Bleeds ClientPatcher = Join-Path $AppDir "dist\desktop\patcher.js"
$Bleeds ClientPatcher = $Bleeds ClientPatcher.Replace("\", "\\")
...
// Injection Bleeds Client
try {
    require(\"$Bleeds ClientPatcher\");
} catch (e) {
    console.error(\"Bleeds Client injection failed:\", e);
